# predict_one.py
# ----------------------------------------------------------
# Prediksi 1 gambar jeruk (FITUR TERPILIH NB3, visual lengkap)
# ----------------------------------------------------------
...
def predict_image(img_path):
    print("🟢 Prediksi Gambar Jeruk (NB3, Fitur SF2, Visualisasi Lengkap)")
    ...
    df["Prediksi"] = prediction
    df.to_csv("csv/testNB3.csv", index=False)
    print("\n📁 Fitur disimpan ke: csv/testNB3.csv")
    ...
    # Tambahkan label prediksi ke hasil crop
